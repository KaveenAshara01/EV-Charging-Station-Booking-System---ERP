...
//         // Purpose: Create a reservation for the authenticated user
//         // Access: authenticated users (EV owners)
//         [HttpPost]
//         [Authorize] // allow any authenticated user; further role checks may be added
//         public async Task<IActionResult> Create([FromBody] CreateReservationDto dto)
//         {
//             // Purpose: get owner id from JWT (expecting claim 'sub' or NameIdentifier)
...
//                 var resp = new DTOs.ReservationResponseDto
//                 {
...
//         // Purpose: Get reservation by id (authenticated)
//         [HttpGet("{id}")]
//         [Authorize]
...
//         // Purpose: Get reservations for current user
//         [HttpGet("me")]
//         [Authorize]
...
//         // Purpose: Update/reschedule a reservation (owner only)
//         [HttpPut("{id}")]
//         [Authorize]
...
//         // Purpose: Get reservations for a station (operator/backoffice)
...
//         // Purpose: approve reservation and generate QR (Backoffice only)
//     [HttpPost("{id}/approve")]
//     [Authorize(Roles = "BACKOFFICE")]  // ensure role matches token claim
//     public async Task<IActionResult> Approve(string id)
//     {
//         // Get approver identity from token (e.g. sub or nameid)
